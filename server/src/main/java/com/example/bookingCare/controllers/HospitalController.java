...
//                else return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Hospital not found with ID: " + id);
//            } catch (Exception e) {
...
//    }
    ...
    public ResponseEntity<Object> createNewHospital(@RequestBody Hospital newHospital) {
        try {
    ...
    public ResponseEntity<Object> deleteUser(@PathVariable Long id) {
        ...
        if (!checkValidId) {
            ...
            if (deleted) {
                return ResponseEntity.status(HttpStatus.OK).body("Hospital with ID " + id + " deleted successfully");
            } else {
                return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Hospital not found with ID: " + id);
            }
        }
